...
- Project = 20,000 บาท
- BiliTV API = 5,000 บาท
- DramaWave API = 4,000 บาท
- ShortMax API = 4,000 บาท
- ReelShort API = 3,000 บาท
- GoodShort API = 3,000 บาท
- StardustTV API = 3,000 บาท
- FlickReels API = 3,000 บาท
- Melolo API = 3,000 บาท
